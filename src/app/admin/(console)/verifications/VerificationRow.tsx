...
import { decideVerification, type CommerceRegistry } from './actions';
            ...
            <div style={{ fontSize: 13, color: 'var(--text-2)', display: 'grid', gap: 3 }}>
                ...
                {req.kind === 'commerce' ? (
                    <>
                        ...
                        <div style={{ color: 'var(--text-3, var(--text-2))' }}>
                            KYC documents: viewer arrives with P2 (private verification-docs bucket).
                        </div>
                    </>
                ) : null}
            </div>
